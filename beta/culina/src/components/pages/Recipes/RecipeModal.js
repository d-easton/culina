                ...
                <div className="modal recipeModal">
                    ...
                    >
                        <div className="recipeCard">
                            ...
                            <div className={this.state.isDisabled ? "recipeBodyFooter disabled" : "recipeBodyFooter"}>
                                <div className="recipeBodyFooterElement" hidden={this.state.isDisabled} >
                                    <label>Image:  </label>
                                    <input type="file" accept=".jpg, .png" ref={this.imageFieldRef} />
                                </div>
                                <div className="recipeBodyFooterElement" hidden={this.state.isDisabled}>
                                    <label>Category:</label> 
                                    <select type="select" id="categories" ref={this.categoryFieldRef}>
