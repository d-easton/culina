      ...
      {user ? (
        <RBS.Navbar collapseOnSelect expand="md" bg="dark" variant="dark">
          ...
          <RBS.Navbar.Collapse id="responsive-navbar-nav">
            <RBS.Nav className="mr-auto"></RBS.Nav>
            <RBS.Nav>
              <RBS.Nav.Link href="/top">Top Recipes</RBS.Nav.Link>
              <RBS.Nav.Link href="/grocery-list">Grocery List</RBS.Nav.Link>
              <RBS.Nav.Link href="/recipe-list">My Recipes</RBS.Nav.Link>
            ...
            <RBS.Nav>
              <RBS.Nav.Link onClick={handleSignout} href="/">
                Sign-Out
              </RBS.Nav.Link>
            </RBS.Nav>
          </RBS.Navbar.Collapse>
